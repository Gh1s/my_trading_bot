...
def TradingOrder():
    ...
    #devises = fxcm_trading_configuration.devises
    df = con.get_candles(fxcm_trading_configuration.devises, period=fxcm_trading_configuration.period,
    ...
    if tradePosition.empty is True:
        ...
        if -1 in sell_position and trend_analysis_sell(trend) == 'SELL':
            ...
            deconnexion(forecast, con, sell_position, buy_position, trend, close_list)
        ...
        if tradePosition[0][14]:
            ...
            if close >= mean_limit or 1 in close_list:
...
def deconnexion(forecast, connexion, sell_position, buy_position, trend, close_position):
